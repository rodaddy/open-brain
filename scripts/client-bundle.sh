...
BUNDLE_HOME="${BUNDLE_HOME:-$HOME/.local/share/open-brain/air-bundle}"
...
[ -n "$BUILD_DEV_ROOT" ] || die "set OPENBRAIN_DEVELOPMENT_ROOT to the build machine's Development root"
