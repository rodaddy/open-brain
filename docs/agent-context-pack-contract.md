...
in-memory for local tests and no hidden repo state is created. Hosted/deployment_host
...
therefore applies: deploy through the current gated deployment_host workflow, verify the
