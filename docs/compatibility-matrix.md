...
Live contract: `2026-08-09.memory-tools.v24` (`src/contract.ts`
...
| `mcp2cli` | Codex durable memory (hosted daemon), cc boxes, generated skills | 0.3.6 | `>=0.3.6 <1.0.0` | `get_contract` manifest; `X-OB-Contract` header forwarding is expected from mcp2cli ≥0.3.6 (owned by the mcp2cli repo; verified live against production-host 2026-07-21) |
