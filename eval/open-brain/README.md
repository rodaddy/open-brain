...
bun run eval:live -- --report /path/to/open-brain/_tmp/open-brain/live-recall.json
```
...
bun run eval:live -- --report /path/to/open-brain/_tmp/open-brain/live-recall-baseline.json
```

Write reports to a scratch path under `/path/to/open-brain/_tmp` unless a
...
bun run eval/open-brain/live/complete-pack-cli.ts --report /path/to/open-brain/_tmp/open-brain/complete-pack.json
```
...
bun run eval:reflex-ab -- --report /path/to/open-brain/_tmp/open-brain/reflex-ab.json
